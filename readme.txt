=== KIP ===
Contributors: pentatonicfunk, dheche
Donate link: http://malang.linux.or.id
...
= 2.2 =
*  Login behaviour
*  Widget pertanyaan pending show question not reason
*  bugfix pertanyaan tidak muncul jika status belum terjawab pada status permohonan informasi
*  Pejabat PID (bukan Pejabat PPID)
*  Set sbg Pemohon
*  Set sbg Pejabat PID
...
= 2.0 =
*  bugfix white label cms
*  move upload dir
*  Ehnancement view pertanyaan terjawab dan pending
*  Penambahan "Belum terjawab selama" di dashboard dan di site
*  Penambahan action_time

= 1.9 =
*  Upload Tanda Pengenal <-- Berkas Tanda Pengenal
*  Upload Tanda Pengenal <-- Unggah Tanda Pengenal
*  Judul Kolom: Data - Nilai <-- dihilangkan
*  judul: Formulir Permohonan Informasi Publik untuk Pertanyaan Baru
*  di dasbor, widget komentar terakhir pindahkan ke bawah konsep terakhir
*  widget pengguna pending: bila tidak ada data tampilkan keterangan "Tidak ada pengguna pending"
*  bila tidak ada data tampilkan keterangan "Tidak ada pertanyaan yang belum terjawab"
*  bila tidak ada data tampilkan keterangan "Tidak ada pertanyaan yang terjawab"
*  bila tidak ada data tampilkan keterangan "Tidak ada pengguna aktif"
*  bila tidak ada data tampilkan keterangan "Tidak ada pengguna pending"
*  bila tidak ada data tampilkan keterangan "Tidak ada pengguna PPID"
*  widget pertanyaan pending


= 1.8 =
*  jika belum ada role ppid dan applicant, buat role tsb
*  default user pendaftar, masukkan sbg applicant
*  set PPID -> role ppid (bukan lagi editor)
*  hide wordpress version
*  custom login logo
*  disable wp logo and link yg ada di pojok kiri atas (adminbar)
*  sidebar login
