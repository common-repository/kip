...
if (!class_exists('CustomContactFormsDashboard')) {
   class CustomContactFormsDashboard extends CustomContactFormsAdmin {
      ...
      function insertDashboardStyles() {
         ...
         wp_register_style('ccf-dashboard', plugins_url() . '/kip/css/custom-contact-forms-dashboard.css');
            wp_register_style('ccf-jquery-ui', plugins_url() . '/kip/forms/css/jquery-ui.css');
            wp_enqueue_style('ccf-jquery-ui');
         wp_enqueue_style('ccf-dashboard');
      }

      function insertDashboardStyles2() {
         wp_register_style('ccf-dashboard', plugins_url() . '/kip/css/custom-contact-forms.css');
         wp_enqueue_style('ccf-dashboard');
      }

      function insertDashboardScripts2() {
         if (!$this->userCanViewWidget()) return;
         wp_enqueue_script('jquery');
//          wp_enqueue_script('jquery-ui-core');
         wp_enqueue_script('my-js', plugins_url() . '/kip/js/my-javascript.js');
